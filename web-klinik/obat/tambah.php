...
<h3 class="mb-4 fw-bold">Tambah Data Obat</h3>

<form action="proses_tambah_obat.php" method="POST" autocomplete="off">
    <div class="mb-3">
        <label for="kode_obat" class="form-label fw-semibold">Kode Obat (Cari dan Pilih)</label>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="number" name="stok" id="stok" class="form-control" min="0" placeholder="Masukkan jumlah stok" required>
        </div>

        <div class="col-md-6 mb-3">
            <label for="stok_minimum" class="form-label fw-semibold">Stok Minimum</label>
            <input type="number" name="stok_minimum" id="stok_minimum" class="form-control" min="0" placeholder="Misal: 10" required>
            <div class="form-text text-muted">* Bila stok kurang dari nilai ini, akan dianggap menipis.</div>
        </div>
    </div>
    ...
    <div class="mt-4">
        <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Simpan Obat</button>
        <a href="../dashboard.php" class="btn btn-secondary ms-2"><i class="bi bi-arrow-left-circle"></i> Batal</a>
    </div>
</form>
